...
**********************************************
***********| 2-Player Chess Game |************
************ Code by Harnish Modi ************
**********************************************
***************| REQUIREMENT |****************
**** 1.pygame, command: pip install pygame ***
**********************************************
"""
...
background = pygame.image.load("chess\\finalchessboard.png")
blue_square = pygame.image.load('chess\\blue.png')
blue_square = blue_square.convert()
blue_square.set_alpha(100)
b_king = pygame.image.load("chess\\b_king.png")
b_queen = pygame.image.load("chess\\b_queen.png")
b_knight = pygame.image.load("chess\\b_knight.png")
b_bishop = pygame.image.load("chess\\b_bishop.png")
b_rook = pygame.image.load("chess\\b_rook.png")
b_pawn = pygame.image.load("chess\\b_pawn.png")
w_king = pygame.image.load("chess\\w_king.png")
w_queen = pygame.image.load("chess\\w_queen.png")
w_knight = pygame.image.load("chess\\w_knight.png")
w_bishop = pygame.image.load("chess\\w_bishop.png")
w_rook = pygame.image.load("chess\\w_rook.png")
w_pawn = pygame.image.load("chess\\w_pawn.png")
